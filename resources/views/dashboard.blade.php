    ...
    <main dir="rtl" class="mx-auto max-w-7xl space-y-8 px-6 py-8">
        ...
        <section class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <div class="rounded-2xl border bg-white p-5 shadow-sm">
                <p class="text-sm text-gray-500">الشحنات المستلمة</p>
            ...
            <div class="rounded-2xl border bg-white p-5 shadow-sm">
                ...
                <p class="mt-1 text-sm text-gray-500">جنيه</p>
            </div>
        </section>
        ...
        <section class="grid gap-6 lg:grid-cols-3">
            <div class="rounded-2xl border bg-white p-6 shadow-sm lg:col-span-2">
                <div class="flex items-center justify-between gap-4">
                    <div>
                        <h2 class="text-lg font-bold">المخازن المبردة</h2>
                        <p class="mt-1 text-sm text-gray-500">الرصيد الحالي في المخازن المفتوحة</p>
                    </div>
            ...
            <div class="rounded-2xl border bg-white p-6 shadow-sm">
                ...
                <div class="mt-5 space-y-2">
                    ...
                    @canPermission('process_pomegranates')
                        <a href="{{ route('processing.index') }}" class="block rounded-xl border px-4 py-3 font-medium hover:bg-gray-50">التصنيع</a>
                    @endcanPermission
